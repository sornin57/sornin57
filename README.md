...
- [devops-platform-api](https://github.com/sornin57/devops-platform-api) - FastAPI service tested, containerized, published to GHCR and deployed on Kubernetes.
- [42-projects](https://github.com/sornin57/42-projects) - 42 school projects grouped in one clean repository with GitHub Actions CI.

## Current Focus

Python backend, Linux, Docker, Kubernetes, CI/CD, Terraform, Ansible, Prometheus/Grafana and practical LLM integration.
